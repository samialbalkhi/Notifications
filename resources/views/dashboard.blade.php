                                    ...
                                    <li class="head text-light bg-dark">
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-12 col-12">
                                                ...
                                                <a href="{{route('notifications')}}" class="float-right text-light">Mark all as read</a>
                                            </div>
                                    </li>
                                    ...
                                    <li class="notification-box">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-sm-8 col-8">
                                                <strong class="text-info">{{$Notifications->data['name']}}</strong>
                                                <div>
                                               <a href="{{route('posts.show',$Notifications->data['id'])}}">   {{$Notifications->data['title']}}</a>
                                                </div>
